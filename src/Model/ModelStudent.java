 ...
 * @author Admin
 */
public class ModelStudent extends ModelPeople{
    private String id_classroom;
    
    public ModelStudent(){
        
    }
    public ModelStudent(String id, String last_name, String first_name, String birthday, String gender, String phone, String email, String id_classroom){
